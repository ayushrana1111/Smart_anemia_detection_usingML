...
if not st.session_state.logged_in:
   ...
   def diagnosis_page():
    ...
    def classify_anemia_type(hemoglobin, mch, mchc, mcv):
        """
        Classify the TYPE of anemia based on MCH, MCHC, MCV values.
        Uses standard WHO/medical classification logic.
        """
        # If normal hemoglobin, no anemia type
        if hemoglobin >= 12.0:
        ...
        # Normocytic Anemia (normal size cells) - normal MCV
        else:
            if mchc < 32:
